...
resignYesButton.addEventListener('click', function() {
     closeResignModal();
        ...
        vsBot = false;
    if(currentTurn === 'w') {
        winnerText.innerHTML = p1Name.innerHTML + " resigned. " +  p2Name.innerHTML + " is the winner!<br>Do you want to play again?";
    } else {
        winnerText.innerHTML =  p1Name.innerHTML + " resigned. " +  p2Name.innerHTML + " is the winner!<br>Do you want to play again?";
    }

    if(vsBot) {
        winnerText.innerHTML =  p1Name.innerHTML + " resigned. 🤖ChessBot is the winner!<br>Do you want to play again?";
    }
})
